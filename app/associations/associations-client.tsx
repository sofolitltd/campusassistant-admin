      ...
      {visibleAssociations.length === 0 ? (
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
          {visibleAssociations.map((association) => (
            <div key={association.id} className="group overflow-hidden rounded-lg border bg-card shadow-xs transition-all hover:shadow-md border-border/60 relative">
              ...
              <div className="absolute top-2 right-12">
                <button
                  onClick={(e) => { e.preventDefault(); e.stopPropagation(); setActiveMenu(activeMenu === association.id ? null : association.id) }}
