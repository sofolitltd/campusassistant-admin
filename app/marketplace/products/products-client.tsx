    ...
    <div className="space-y-6 animate-in fade-in duration-300">
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <p className="text-muted-foreground text-sm">In-house and merchant products listed in the Campus Marketplace.</p>
        </div>
        <Link
          href="/marketplace/products/add"
      ...
      {products.length === 0 ? (
        <div className="flex h-64 flex-col items-center justify-center rounded-xl border-2 border-dashed bg-card/50 text-center">
          ...
          <p className="mt-1 max-w-xs text-xs text-muted-foreground font-medium">
            Create your first product to list it in the marketplace.
          </p>
          <Link href="/marketplace/products/add" className="mt-4 flex items-center gap-2 rounded-lg bg-primary px-4 py-2 text-sm font-bold text-primary-foreground shadow-sm">
              ...
              <div className="p-3">
                <div className="flex items-start justify-between gap-2">
                  <div className="min-w-0 flex-1">
                    <h3 className="font-bold text-sm h-10 line-clamp-2 leading-tight group-hover:text-primary transition-colors" title={product.title}>
                      {product.title}
                    </h3>
                ...
                <div className="mt-4 flex items-center justify-between border-t border-dashed pt-3 border-border/60">
                  ...
                  <div className="flex items-center gap-1 text-[10px] font-bold text-muted-foreground bg-muted px-1.5 py-0.5 rounded-sm">
                    ...
                    <span className="truncate max-w-[80px]">{product.merchant?.is_platform ? "In-house" : product.merchant?.business_name ?? "—"}</span>
                  </div>
                </div>
              </div>
            </div>
